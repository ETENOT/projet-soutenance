...
export interface ShepherdModalAPI {
	...
	destroy: () => void;
	hide: () => void;
	positionModal: (modalOverlayOpeningPadding?: number, modalOverlayOpeningRadius?: ModalRadiusType, modalOverlayOpeningXOffset?: number, modalOverlayOpeningYOffset?: number, targetScrollParent?: HTMLElement | null, targetElement?: HTMLElement | null, extraHighlights?: HTMLElement[]) => void;
...
export declare class Tour extends Evented {
	 ...
	 * @private
	 */
	_skipStep(step: Step, forward: boolean): void | Promise<void>;
	/**
